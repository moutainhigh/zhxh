...
public class ReceiveAction_z {
	 ...
	 * 快钱支付-服务接收
	 * */
	@RequestMapping(value="/kq/receive_z")
	public void receive_z(HttpServletRequest request, HttpServletResponse response) throws Exception {
	  		...
	  		switch(Integer.parseInt(payResult))
	  		{
	  			case 10:
  					...
  					*/
	  				...
	  				int num = userBankService.rechargeZ(bill, user.getIdentity());
	  				if(num > 0){
	  					rtnOK=1;
