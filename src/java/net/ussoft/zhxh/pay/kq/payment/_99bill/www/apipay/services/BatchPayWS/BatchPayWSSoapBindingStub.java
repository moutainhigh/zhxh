...
public class BatchPayWSSoapBindingStub extends org.apache.axis.client.Stub implements net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPay {
    ...
    public BatchPayWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.QueryRequestBean.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {input, username, ip});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.QueryResponseBean[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.QueryResponseBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.QueryResponseBean[].class);
            }
        }
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {input, username, ip});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.BankResponseBean[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.BankResponseBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.BankResponseBean[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {input, username, ip});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.SimpleResponseBean[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.SimpleResponseBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.SimpleResponseBean[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {input, username, ip});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.PostResponseBean[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.PostResponseBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, net.ussoft.zhxh.pay.kq.payment.bill99.seashell.domain.dto.complatible.PostResponseBean[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
