...
public class BatchPayServiceLocator extends org.apache.axis.client.Service implements net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPayService {
    ...
    public net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPay getBatchPayWS() throws javax.xml.rpc.ServiceException {
    ...
    public net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPay getBatchPayWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPayWSSoapBindingStub _stub = new net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPayWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPay.class.isAssignableFrom(serviceEndpointInterface)) {
                net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPayWSSoapBindingStub _stub = new net.ussoft.zhxh.pay.kq.payment._99bill.www.apipay.services.BatchPayWS.BatchPayWSSoapBindingStub(new java.net.URL(BatchPayWS_address), this);
                _stub.setPortName(getBatchPayWSWSDDServiceName());
                return _stub;
            }
        }
