    ...
    <script type="text/javascript">
	    ...
	    var orderstatus = "";
	   	$(function(){
	    	...
	    	grid_order.set({
	    		url:"${pageContext.request.contextPath}/syspo/customerpolist.htmls",
	    		columns: [
							{ type: "checkcolumn",headerAlign:"center",width: 30},
	      	                ...
	      	                { field: "u_compname",name:"u_compname", width: '30%', headerAlign: "center", align:"left",allowSort: false, header: "会员名称"},
	      	              	{ field: "s_compname",name:"s_compname", width: '30%', headerAlign: "center", align:"left",allowSort: false, header: "代下单机构"},
        ...
        function search() {
        	...
        	grid_order.load({status:orderstatus,search:keyword});
		}
		function selStatus(v){
			orderstatus = v;
			var keyword = mini.get("keyword").getValue();
			grid_order.load({status:v,search:keyword});
		}
