    ...
    <script type="text/javascript">
	    ...
	    var sel_a ="";
	   	...
	   	$(function(){
	    		...
	    		columns: [
							{ type: "checkcolumn",headerAlign:"center",width: 30},
	      	                ...
	      	                { field: "u_companyname",name:"u_companyname", width: 80, headerAlign: "center", align:"center",allowSort: false, header: "客户名称"},
	      	              	{ field: "ordertime",name:"ordertime",dateFormat:"yyyy-MM-dd",width: 100, headerAlign: "center", align:"center",allowSort: false, header: "订单时间"},
	    	...
	    	grid_order.load({parentid:'1',orderType:'sub'});
        ...
        function search(gridtype) {
        	...
        	var parentid = "";
        	var identity = "";
      		if (gridtype == "grid_order") {
      			tmpGrid = grid_order;
      			key = mini.get("key_user_a").getValue();
      			parentid = "1";
      			identity = "A";
      		}
      		else if (gridtype == "grid_order_pro") {
      			tmpGrid = grid_order_pro;
      			key = mini.get("key_user_c").getValue();
      			parentid = sel_a;
      			identity = "C";
      		}
      		else if (gridtype == "grid_order_wl") {
      			tmpGrid = grid_order_wl;
            ...
            if (gridtype == "grid_order") {
            	grid_order_pro.setData([]);
            	grid_order_pro.setTotalCount(0);
            	grid_order_wl.setData([]);
            	grid_order_wl.setTotalCount(0);
            }
        ...
        function onKeyEnter(e) {
        	...
        	if (sender.id == "key_user_a") {
        		...
        		gridtype = "grid_order_pro";
        	}
        	else if (sender.id == "key_user_z") {
        		gridtype = "grid_order_wl";
        	}
            search(gridtype);
        }
