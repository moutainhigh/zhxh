    ...
    <script type="text/javascript">
	    ...
	    var grid;
	   	$(function(){
	    	...
	    	grid.load({identity:'C',companycode:'-1'});
	    });
        ...
        function search() {
            ...
            key = key == "" ? "-1":key;
            grid.load({identity:'C',companycode:key});
        }
        ...
        <table style="width:100%;">
            <tr>
                <td style="white-space:nowrap;">
                    <input id="key" class="mini-textbox" emptyText="请输入机构代码" style="width:150px;" onenter="onKeyEnter"/>   
