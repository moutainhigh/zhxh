    ...
    <script type="text/javascript">
	    ...
	    var grid_user_z;	//普通会员
	   	...
	   	$(function(){
	    	...
	    	grid_user_z.load({identity:'Z',showtype:0});
        ...
        function search(gridtype) {
            ...
            if (key != "") {
                ...
                tmpGrid.load({parentid:parentid,identity:identity,showtype:0,mapObj: mapObj });
            }
            else {
            	tmpGrid.load({parentid:parentid,identity:identity,showtype:0});
            }
      ...
      //删除
        ...
        function initUpdatePass(gridtype) {
      	...
      	function move(gridtype){
            ...
            mini.open({
            	url: "${pageContext.request.contextPath}/common/dispatch.htmls?page=/view/system/member/selectUser",
                title: "将选择的机构移动到新的上级机构下", width: 800, height: 500,
                onload: function () {
                    var iframe = this.getIFrameEl();
               ...
               <div class="mini-toolbar" style="padding:3px;border-top:0;border-left:0;border-right:0;border-bottom:1;">
               	<table style="width:100%;">
		            <tbody>
		             <tr>
		                 <td style="width:100%;">
		                 	<span id="pid" style="padding-left:5px;">门店列表</span>
		                 </td>
