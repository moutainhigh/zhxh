    ...
    <script type="text/javascript">
		...
		function SetData(data) {
			...
			var uploader = new plupload.Uploader({
	    		...
	    		max_file_count:1,
	    		url : "${pageContext.request.contextPath}/common/upload_file.htmls?id="+id,
	    		chunk_size : '2mb',
	    		// Flash settings
	...
	<div class="mini-toolbar" style="padding:0px;border-top:0;border-left:0;border-right:0;">
        <table style="width:100%;">
             <tbody>
	             <tr>
	                 <td style="">
						<div id="filelist" style="float:left;padding-left:5px;">请选择文件。</div>
						<div id="console"></div>
	                 </td>
	                 <td style="white-space:nowrap;" width="200">
	                 	<div id="container" style="float:right">
	                 		<a id="pickfiles" class="mini-button" plain="true" name="auth">选择文件</a>
