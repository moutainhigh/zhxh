...
<script type="text/javascript">
		...
		var grid;
       	...
       	$(function(){
        	...
        	grid.set({
        		...
        		columns: [
						{ type: "checkcolumn",headerAlign:"center",width: 50},
      	                ...
      	                { field: "pic_url",name:"pic_url", width: 120, headerAlign: "center", align:"center",allowSort: false, header: "图片(300*200)",editor: { type:"buttonedit",allowInput:false,onbuttonclick:"onBtnNewsPicEdit"} },
        	...
        	grid.load({act:'public_content',parentid:'news',parenttype:'sp'});
        	drawcell();
        })
        ...
        function onActionRenderer(e) {
       	...
       	function getUrl(id) {
       		...
       		mini.alert(serv_path + "/pcMain/news-c.htmls?id=" + id);
       	}
		...
		function save() {
	        ...
	        $.ajax({
	            ...
	            data: {'objs':json,'act':'public_content','parentid':'news','parenttype':'sp'},
	            type: "post",
	            dataType:"text",
	...
	<div class="mini-toolbar" style="padding:0px;border-top:0;border-left:0;border-right:0;">
        <table style="width:100%;">
            <tbody>
             <tr>
                 <td style="width:100%;">
                 	<span id="pid" style="padding-left:5px;">商品新闻</span>
                 </td>
