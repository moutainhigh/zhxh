...
<script type="text/javascript">
		...
		var grid;
       	...
       	$(function(){
        	...
        	grid.load({act:'public_content',parentid:'service',parenttype:'job'});
        	drawcell();
        })
		...
		function save() {
	        ...
	        $.ajax({
	            ...
	            data: {'objs':json,'act':'public_content','parentid':'service','parenttype':'job'},
	            type: "post",
	            dataType:"text",
	...
	<div class="mini-toolbar" style="padding:0px;border-top:0;border-left:0;border-right:0;">
        <table style="width:100%;">
            <tbody>
             <tr>
                 <td style="width:100%;">
                 	<span id="pid" style="padding-left:5px;">工作招聘</span>
                 </td>
