...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
    	...
    	function loadData() {
    		...
    		$.ajax({
    			async:false,
                url: "${pageContext.request.contextPath}/orderUserDis/listSelectSize.htmls",
                data: par,
                type: "post",
                dataType:"json",
                success: function (json) {
                	...
                	totalPage = Math.ceil(json.total/pageSize);
               	 	$(".admin_panel").setTemplateURL("${pageContext.request.contextPath}/view/order/tpl/userDis/selectSize.tpl");
               	 	$(".admin_panel").setParam('rowCount', json.total);
	         		$(".admin_panel").setParam('pageSize', pageSize);
	         		$(".admin_panel").setParam('pageIndex', pageIndex);
	         		$(".admin_panel").setParam('totalPage', totalPage);
