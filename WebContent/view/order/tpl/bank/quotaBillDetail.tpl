			...
			<td colspan="9" style="text-align:right" >
				<div class="page">
					...
					<div class="page-number">
						...
						{#else}
							<a href="javascript:void(0);" class="ui-pager-prev" onclick="pageClick({$P.pageIndex-1},3)">上一页</a>
						{#/if}
						{#if $P.pageIndex == $P.totalPage || $P.totalPage == 0}
							<a href="javascript:void(0);" class="ui-pager-next">下一页</a>
						{#else}
							<a href="javascript:void(0);" class="ui-pager-next" onclick="pageClick({$P.pageIndex + 1 },3)">下一页</a>
						{#/if}
						</div>
					</div>
				</div>
