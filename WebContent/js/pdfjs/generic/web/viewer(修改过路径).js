...
PDFJS.imageResourcesPath = getRootPath() + '/js/pdfjs/generic/web/images/';
PDFJS.workerSrc = getRootPath() + '/js/pdfjs/generic/build/pdf.worker.js';
PDFJS.cMapUrl = getRootPath() + '/js/pdfjs/generic/web/cmaps/';
